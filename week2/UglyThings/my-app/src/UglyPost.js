...
class UglyPost extends React.Component {
    state = {
        ...
        newPostTitle: "",
        newPostDescription: "",
        postImage: this.props.post.imgUrl,
        newComment: {
            id: 200,
            text: ""
        },
    ...
    updatePost = (e) => {
        ...
        this.props.updatePostValue(this.state.postId, !this.state.newPostTitle ? this.props.post.title: this.state.newPostTitle, !this.state.newPostDescription ? this.props.post.description: this.state.newPostDescription);
    }
    ...
    render() {
        return(
            <div className="uglyPost" id={this.props.post.id}>
                ...
                <img className="postImage" src={this.state.postImage} alt="ugly thing"/>
